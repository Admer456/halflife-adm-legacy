...
============
*/
#define AIRTIME	22		// lung full of air lasts this many seconds
...
void CBasePlayer::WaterMove()
{
	...
	if (pev->waterlevel != 3) 
	{
		...
		/*
		if (pev->air_finished < gpGlobals->time)
			EMIT_SOUND(pev), CHAN_VOICE, "player/adm_wbreathe1.wav", 1, ATTN_NORM); // Long breath
		else if (pev->air_finished > gpGlobals->time)
			EMIT_SOUND(pev), CHAN_VOICE, "player/adm_wbreathe2.wav", 1, ATTN_NORM); // Fast breathing
		To-do: record the sounds, then we can decomment the code
		*/
...
/*
===========================================================
AdmSrc - The mini ControlAPI
===========================================================
*/

void CBasePlayer::SetKeyButton(CtrlApi_key_t key, bool state)
{
	m_KeyButton[key] = state;
...
bool CBasePlayer::GetKeyButton(CtrlApi_key_t key)
{
		return m_KeyButton[key];
}
