...
// AdmSrc - this is what I get for messing with the base class, the client DLL couldn't compile so I had to add these two here // Edit: three, not two
void CBaseEntity :: GetKeyValue(char &szTheValue, char szTargetKey[64]) { }
...
void CBaseDelay :: GetKeyValueBase(char &szTheValue, char szTargetKey[64]) { }
...
void CBaseAnimating::GetKeyValueBase(char &szTheValue, char szTargetKey[64]) { }
...
void CBaseToggle :: GetKeyValueBase(char &szTheValue, char szTargetKey[64]) { }
