...
int DrawBar(int x, int y, int width, int height, float f)
{
	...
	if (f)
	{
		...
		FillRGBA(x, y, w, height, r, g, b, (255 * CVAR_GET_FLOAT("adm_hud_a")));
		x += w;
		width -= w;
	}
	...
	FillRGBA(x, y, width, height, r, g, b, (128 * CVAR_GET_FLOAT("adm_hud_a")));
	...
	for (i = 0; i < MAX_WEAPON_SLOTS; i++)
	{
		...
		if ( i == iActiveSlot )
		{
			...
			for ( int iPos = 0; iPos < MAX_WEAPON_POSITIONS; iPos++ )
			{
				...
				if ( gpActiveSel == p )
				{
					ScaleColors(r, g, b, (255 * CVAR_GET_FLOAT("adm_hud_a")));
				...
				else
				{
					...
					if ( gWR.HasAmmo(p) )
						ScaleColors(r, g, b, (192 * CVAR_GET_FLOAT("adm_hud_a")));
					else
					{
						UnpackRGB(r,g,b, RGB_REDISH);
						ScaleColors(r, g, b, (128 * CVAR_GET_FLOAT("adm_hud_a")));
					}
