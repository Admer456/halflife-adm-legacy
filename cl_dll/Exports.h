...
#define RecClHUD/hud.hInit()					(g_pcldstAddrs->pHUD/hud.hInitFunc())
#define RecClHUD/hud.hVidInit()				(g_pcldstAddrs->pHUD/hud.hVidInitFunc())
#define RecClHUD/hud.hRedraw(a, b)			(g_pcldstAddrs->pHUD/hud.hRedrawFunc(&a, &b))
#define RecClHUD/hud.hUpdateClientData(a, b)	(g_pcldstAddrs->pHUD/hud.hUpdateClientDataFunc(&a, &b))
#define RecClHUD/hud.hReset()					(g_pcldstAddrs->pHUD/hud.hResetFunc())
...
#define RecClHUD/hud.hFrame(a)				(g_pcldstAddrs->pHUD/hud.hFrame(&a))
