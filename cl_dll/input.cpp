...
/*	gEngfuncs.pfnAddCommand("+veh_acc",  IN_VAccDown);
	gEngfuncs.pfnAddCommand("-veh_acc",  IN_VAccUp);
	gEngfuncs.pfnAddCommand("+veh_dec",  IN_VDecDown);
	gEngfuncs.pfnAddCommand("-veh_dec",  IN_VDecUp);
	gEngfuncs.pfnAddCommand("+veh_lt",   IN_VLtDown);
	gEngfuncs.pfnAddCommand("-veh_lt",   IN_VLtUp);
	gEngfuncs.pfnAddCommand("+veh_rt",   IN_VRtDown);
	gEngfuncs.pfnAddCommand("-veh_rt",   IN_VRtUp);
	gEngfuncs.pfnAddCommand("+veh_hdbk", IN_VHdbkDown);
	gEngfuncs.pfnAddCommand("-veh_hdbk", IN_VHdbkUp); */
	gEngfuncs.pfnAddCommand("+veh_cltc", IN_VCltcDown);
	gEngfuncs.pfnAddCommand("-veh_cltc", IN_VCltcUp);
	gEngfuncs.pfnAddCommand("+veh_up",	 IN_VUpDown);
	gEngfuncs.pfnAddCommand("-veh_up",   IN_VUpUp);
	gEngfuncs.pfnAddCommand("+veh_dn",   IN_VDnDown);
	gEngfuncs.pfnAddCommand("-veh_dn",   IN_VDnUp);
	gEngfuncs.pfnAddCommand("+veh_llt",  IN_VLLtDown);
	gEngfuncs.pfnAddCommand("-veh_llt",  IN_VLLtUp);
	gEngfuncs.pfnAddCommand("+veh_lrt",  IN_VLRtDown);
	gEngfuncs.pfnAddCommand("-veh_lrt",  IN_VLRtUp);
/*	gEngfuncs.pfnAddCommand("+veh_jump",	IN_VJumpDown);
	gEngfuncs.pfnAddCommand("-veh_jump",	IN_VJumpUp); 
	gEngfuncs.pfnAddCommand("+veh_attack", IN_VAttackDown);
	gEngfuncs.pfnAddCommand("-veh_attack", IN_VAttackUp); */

/*	gEngfuncs.pfnAddCommand("+veh_flash", IN_VFlashDown);
	gEngfuncs.pfnAddCommand("-veh_flash", IN_VFlashUp); */
	gEngfuncs.pfnAddCommand("+veh_unuse", IN_VUnuseDown);
	gEngfuncs.pfnAddCommand("-veh_unuse", IN_VUnuseUp); 
	gEngfuncs.pfnAddCommand("+veh_start", IN_VStartDown);
	gEngfuncs.pfnAddCommand("-veh_start", IN_VStartUp);
	gEngfuncs.pfnAddCommand("+veh_seats", IN_VSeatsDown);
	gEngfuncs.pfnAddCommand("-veh_seats", IN_VSeatsUp);

/*	gEngfuncs.pfnAddCommand("+veh_fire1", IN_VShootDown);
	gEngfuncs.pfnAddCommand("-veh_fire1", IN_VShootUp);
